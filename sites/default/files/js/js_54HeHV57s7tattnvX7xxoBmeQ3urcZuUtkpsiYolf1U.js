    ...
    attach: function attach(context, settings) {
      ...
      if (elements.length > 0) {
        ...
        elements.each(function () {
          var data = $(this).data(); // Set element background color
...
; (function (window) {
    ...
    function ReadingTime(numberWordsPerMinute, readigTimeLabel, minutesLabel, wordsLabel, lessThanAMinuteLabel) {
        ...
        var wordsPerMinute = numberWordsPerMinute;
        // Select all the paragraphs in element with ID readText.
        var paragraphs = document.querySelectorAll('.article-content-wrapper .text-formatted p');
...
(function ($) {
  ...
  $('#edit-name').attr('value', '').attr('placeholder', 'İsim');
  $('#edit-subject-0-value').attr('placeholder', 'Konu');
  $('#edit-field-comment-body-0-value').attr('placeholder', 'Yorumunuz...');
